...
const Sidebar = () => {
    ...
    const allItems = [
        { label: 'Home', icon: 'pi pi-home', route: '/BoardHome', allowedUserIds: [1] },
    ];
...
//     const allItems = [
//         { label: 'Home', icon: 'pi pi-home', route: '/BoardHome', allowedUserIds: [1] },
//         { label: 'Faculty allocation', icon: 'pi pi-file-edit', route: 'BoardAllocation', allowedUserIds: [1] },

//         { label: 'Requests', icon: 'pi pi-file-check', route: '/BoardApproval', allowedUserIds: [1] },
